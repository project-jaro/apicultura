                ...
                <ul className="flex items-center -space-x-px h-8 text-sm">
                    ...
                    <li>
                        ...
                        >
                            ...
                            <svg className="w-2.5 h-2.5 text-tiber-500 dark:text-yellow-400" aria-hidden="true" fill="none" viewBox="0 0 6 10">
                        ...
                        <li key={noPage}>
                            <a
                                ...
                                className={`flex items-center justify-center px-3 h-8 leading-tight text-gray-500 border border-gray-300
                                    ${currentPage === noPage
                                        ? 'bg-tiber-500 text-white dark:bg-yellow-400 dark:text-pearl-950' // Estilos para la página actual
                    ...
                    <li>
                        ...
                        >
                            ...
                            <svg className="w-2.5 h-2.5 text-tiber-500 dark:text-yellow-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
